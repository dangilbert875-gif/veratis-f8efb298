...
const sections = [
  {
    ...
    items: [
      ["Are your peptides for human use?", "No. All Pure Peptide products are intended strictly for in-vitro laboratory and research use. They are not for human or veterinary consumption."],
