...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pure Peptide — Research-Grade Peptides, Third-Party Tested" },
      ...
      { name: "twitter:title", content: "Pure Peptide — Research-Grade Peptides, Third-Party Tested" },
