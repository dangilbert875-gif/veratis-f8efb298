      ...
      <div className="w-full max-w-sm">
        ...
        <div className="border border-ink/12 bg-background p-8">
          ...
          <button
            ...
            className="w-full h-10 inline-flex items-center justify-center gap-2 border border-ink/15 bg-background text-[13px] text-ink hover:bg-ink/5 disabled:opacity-50 transition-colors"
          >
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-[10px] tracking-[0.12em] uppercase">
              <span className="bg-background px-3 text-foreground/40">or use email</span>
            </div>
          </div>
